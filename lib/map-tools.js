...
var Config = (function () {
    ...
    // Config.url = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyC-1-DDpWiQXOYsqIJRpiuMCZbCsVbxVZM&callback=initMap';
    Config.zoom = 8;
...
var Maps = (function () {
    ...
    Maps.load = function (id, args) {
        ...
        var apiKey = args.apiKey ? args.apiKey : 'AIzaSyC-1-DDpWiQXOYsqIJRpiuMCZbCsVbxVZM';
        var surl = 'https://maps.googleapis.com/maps/api/js?key=' + apiKey + '&callback=initMap';
        script.src = surl+ '?v=' + version + '&callback=mapTools.maps.' + id + '.create';
        // script.src = config.url + '?key=AIzaSyC-1-DDpWiQXOYsqIJRpiuMCZbCsVbxVZM' + '?v=' + version + '&callback=mapTools.maps.' + id + '.create';
